 ...
 * generated in the com.myloverqian.server.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://impl.Server.myloverqian.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.Server.myloverqian.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.myloverqian.server.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.Server.myloverqian.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.Server.myloverqian.com/", name = "queryWeatherResponse")
